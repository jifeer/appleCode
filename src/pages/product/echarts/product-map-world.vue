...
//                console.log(params)
              if (params.value) {
                return `<div style="text-align: left;">
                        ...
                        <p>${params.data.type == '121689' ? '采购总量' + (params.data.value ? params.data.value.toFixed(2) : '-') + '万亩' : params.data.type == '112716' ? '产量：' + (params.data.value ? params.data.value.toFixed(2) : '-') + '个' : '-'}</p>
